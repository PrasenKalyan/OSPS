...
?>
                               ...
                               <td align="left">
                                      ...
                                      <input type="hidden" name="sno" value="<?php echo $id;?>">  
                                       <input type="submit" name="sub1" value="Update Dispatched">
                                   </form>
...
$result1=mysqli_query($link,$sql1);
  ...
  $comment=$_POST['comment'];
   $sno=$_POST['sno'];
    ...
    $sq=mysqli_query($link,"update productsentry set manager='dispatched',wherehouse_comment='$comment' where sno='$sno'  and manager='approved'" );
    if($sq){
         print "<script>";
			print "alert('Dispatched Successfully Updated');";
