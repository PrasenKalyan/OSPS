...
$strSQL2 = "select * from productsentry where manager='approved' group by id";
...
while ($r = mysqli_fetch_array($res)) {
    ...
    // $fath=$row['fname'];
    ?><tr><td><?php echo $r['sno']; ?></td><td><?php echo $r['sitename']; ?></td><td><?php echo $r['indid']; ?></td><td><?php echo $r['data']; ?></td><td><?php echo $r['uploadby']; ?></td></tr>
<?php
}?>
