...
session_start();
 ...
 $counti=1;
     ...
     $stmt = $conn->prepare("SELECT id,uploadby,loc,sname,indid,sarea,sstate,com,date,time,chimage1,chimage2,chimage3,chimage4,chpdf,category,phoneno,ptwno,reply,fundrequest  FROM request where uploadby='$uname' and phoneno!='' and (date='$datei' or datecheck='$datei')   ORDER BY id desc ");
...
<a class="next" onclick="plusSlides(1,<?php echo $counti?>)">❯</a>
    ...
    <div class="col-sm-8">
        <table style="width:100%">
           ...
           ?></p></tr>
             <?php if($fr!='not'){ ?>
           <tr> <p style="color:green;"><b>Fund request: </b><?php echo $fr;
           ?></p></tr>
           <?php } ?>
